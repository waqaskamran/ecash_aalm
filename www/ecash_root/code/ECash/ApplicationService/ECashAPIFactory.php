<?php
/**
 * Description of ECash_ApplicationService_ECashAPIFactory
 *
 * @copyright Copyright &copy; 2014 aRKaic Equipment
 * @package ApplicationService
 * @author Randy Klepetko <randy.klepetko@sbcglobal.net>
 */
class ECash_ApplicationService_ECashAPIFactory implements ECash_Service_ApplicationService_IECashAPIFactory
{
	private $db;
	private $company;
