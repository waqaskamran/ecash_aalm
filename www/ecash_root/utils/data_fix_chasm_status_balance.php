<?php
/**
php data_fix_chasm_status_balance.php
*/
...
-- AND ap.authoritative_id IN (901698245,901698246,901698359,901698293)
...
AND tt.name_short IN ('loan_disbursement','card_disbursement')
AND tr.transaction_status='pending'
";
$result_ldb_check1 = $db_ldb->query($query_ldb_check1);
$row_ldb_check1 = $result_ldb_check1->fetch(PDO::FETCH_OBJ);
if ($row_ldb_check1->transaction_register_id) continue;
...
//Update_Status(NULL, $application_id, "recovered::external_collections::*root");
}
