<?php
/**
php data_fix_bus_rule_company_level.php
*/
...
from rule_component
where name_short='collections_processes'
";
$result = $db->query($sql);
$row = $result->fetch(PDO::FETCH_OBJ);
...
"days_until_general" => "Days Until Collections General",
"days_until_rework" => "Days Until Collections Rework",
"days_until_second_tier" => "Days Until Collections Second Tier"
);
$sequence_no = 1;
...
description = 'This rule determines how long an app can stay in appropriate queue',
parm_type = 'integer',
