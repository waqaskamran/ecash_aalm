...
///////////////////////////////////////FUND
$name_short = 'loan_disbursement';
$comment = 'ACH Disbursement - Restored';

$bwo_balance = array(
'principal' => $fund_amount,
'service_charge' => 0,
'fee' => 0,
'irrecoverable' => 0
);
...
AND transaction_type_id=1 -- Fund
...
$assesment_amount = $fund_amount * $rate_percent / 100;
