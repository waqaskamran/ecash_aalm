<?php
/**
php data_fix_align_action_date_for_card.php <application_id>
*/
...
if ($_SERVER['argc'] != 2)
{
echo "Usage: php data_fix_align_action_date_for_card.php <application_id>, for example, php data_fix_align_action_date_for_card.php 700000014\n";
exit(1);
}
