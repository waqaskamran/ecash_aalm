<?php
/**
php data_fix_insert_sc_principal.php
*/
...
////////////////////////////////////////////////////PRINCIPAL
$name_short = 'repayment_principal';
$comment = 'Principal Payment';

$bwo_balance = array(
'principal' => $amount_princ,
'service_charge' => 0,
'fee' => 0,
'irrecoverable' => 0
);
...
WHERE
application_id={$application_id}
AND transaction_type_id=2 -- Princ
ORDER BY transaction_register_id DESC
LIMIT 1
";
$result40 = $db->query($query40);
