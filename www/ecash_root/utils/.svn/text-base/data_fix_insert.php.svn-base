...
if ($_SERVER['argc'] > 1)
{
	...
	$application_id = ;
	$name_short = 'converted_principal_bal';
	$comment = 'Principal Balance Forward';
	$amount = 50;		// - for DEBITS --- CREDITS +++++ !!!!!!!!!
	$tomorrow = $today = date("Y-m-d");
	$date_created = date("Y-m-d H:i:s");
	//$today = '2013-07-09';
	//$tomorrow = '2013-07-09';
	//$date_created = '2013-07-09 09:00:00';
