...
for ($i = 0; $i++; $i<100){
    ...
    foreach ($chasm_missing_array as $id_string){
        $missing_chasm_string .= $id_string;
    }
...
echo $key_test_string;
echo $null_test_string;
echo $field_test_string;
echo $missing_test_string;
echo $missing_chasm_string;
echo $missing_ldb_string;
