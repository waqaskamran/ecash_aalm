...
require_once(SERVER_CODE_DIR . "verification_performance_query.class.php");
...
class Report extends Report_Generic
{
	...
	public function Generate_Report()
	{
		...
		try
		{
			$this->search_query = new Verification_Performance_Report_Query($this->server);
			...
			$_SESSION['reports']['performance']['url_data'] = array('name' => 'Verification Performance', 'link' => '/?module=reporting&mode=verification_performance');
