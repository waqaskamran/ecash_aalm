 ...
 * @category Display
 */
class Agent_Comments_Report extends Report_Parent
{
	/**
	...
	public function __construct(ECash_Transport $transport, $module_name)
	{
		...
		$this->report_title = "Agent Comments Report";
	...
	protected function Get_Form_Options_HTML(stdClass &$substitutions)
	{
		...
		if( $this->comment_flag === true ) {
			$substitutions->loan_type_select_list = '<span>Comment Flag: </span><span><select name="comment_flag" size="1" style="width:100px;"></span>';
