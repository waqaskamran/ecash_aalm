 ...
 * @category Display
 */
class Aging_Report extends Report_Parent
{
	/**
	...
	public function __construct(ECash_Transport $transport, $module_name)
	{
		...
		$this->report_title       = "Aging Report";

		$this->column_names       = array( 'name_full'		=> 'Customer Name',
										   'application_id' => 'Application ID',
		                                   'fund_date' 		=> 'Effective Date',
		                                   'due_date'  		=> 'Due Date',
		                                   'balance'   		=> 'Principal',
		                                   'interest'   	=> 'Interest',
		                                   'fee'   			=> 'Fee',
        ...
        $this->totals 	= array('company' => array( 'balance', 'interest','fee', 'total','rows'),
        						'grand' =>  array( 'balance', 'interest','fee', 'total','rows'));
