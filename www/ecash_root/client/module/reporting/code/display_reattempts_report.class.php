 ...
 * @category Display
 */
class Reattempts_Report extends Report_Parent
{


	public function __construct(ECash_Transport $transport, $module_name)
	{
		$this->report_title       = "Reattempts Report";
		/*
	...
	echo '<tr><th>Date</th><th>New Principal</th><th>New Svc. Chg.</th><th>New Fees</th>
		...
		*/
		...
		$this->sort_columns       = array( 'reattempt_date',        'new_principal',
		                                   'new_svr_charge', 	'new_svr_charge',
		                                   'new_fees',        're_principal',
		                                   're_svr_charge',       're_fees' );
		$this->link_columns       = array();
		
		$this->column_format      = array(
		                                   'reattempt_date'   	=> self::FORMAT_DATE,
