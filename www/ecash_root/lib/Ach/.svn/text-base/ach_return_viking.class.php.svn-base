...
/**
* Class for handling ACH returns from Viking
*/
class ACH_Return_Viking extends ACH_Return implements ACH_Return_Interface
{
	/**
	 * Viking's Return File Format
	 */
	static protected $return_file_format = array(
		...
		*/
		'return_date',                  // Field 1, Return Date
		'company_entry_description',	// Field 2
		'company_discretioinary_data',	// Field 3
		'ach_id',                 	// Field 4
		'correct_routing_number',	// Field 5
		'correct_acct_number',		// Field 6
		'recipient_id',                 // Field 7 ach_id
		'recipient_name',		// Field 8
		'amount',			// Field 9
		'return_reason',           	// Field 10
		'reason_code',                  // Field 11
		'addenda_info',			// Field 12 corrected_data
		'viking_return_id',		// Field 13
		'individual_id',		// Field 14
	);

	/**
	 * Viking's Corrections File Format
	 *
	 */
	/*
	//asm 114 - commnent
				...
				*/
				...
				if (is_numeric($ach_id) && ($ach_id > $min_ach_id))
				{
					...
					*/
					...
					//if ($report_type == 'returns' && substr($reason_code, 0, 1) !== "C") //asm 114
					if (substr($reason_code, 0, 1) === "R")
					{
					...
					//elseif ($report_type == 'corrections') //asm 114
					elseif (substr($reason_code, 0, 1) === "C")
					{
						// Process corrections -- update related application data, if possible
						
						/**
						 * Viking delimits their data fields using whitespace
						 */
