...
//////////////////////////////////////////////////////////////////////////////////////////////////
				$query = "SELECT * FROM access_group WHERE name LIKE '%lcs%'";
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$query = "UPDATE access_group SET name = REPLACE(name, 'MYDY', 'LCS');";
				$res = $mysqli->query($query);
                if ($mysqli->affected_rows != 22)
                    $this->db[$company][$rc_lvl]['applied'] = false;
///////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$query = "UPDATE access_group SET name = REPLACE(name, 'LCS', 'MYDY');";
                $res = $mysqli->query($query);
//////////////////////////////////////////////////////////////////////////////////////////////////
