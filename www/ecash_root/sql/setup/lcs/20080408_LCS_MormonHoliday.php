...
//////////////////////////////////////////////////////////////////////////////////////////////////
				$query = "SELECT * FROM holiday WHERE name='Pioneer Day'";
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$query = "INSERT INTO holiday (active_status, holiday, name) VALUES ('active','2008-07-24','Pioneer Day'),
																			        ('active','2009-07-24','Pioneer Day'),
																			        ('active','2010-07-24','Pioneer Day');";

				$res = $mysqli->query($query);

				$this->db[$company][$rc_lvl]['applied'] = true;
				
				if ($mysqli->affected_rows != 3)
				{
					$this->db[$company][$rc_lvl]['applied'] = false;
				}
///////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$query = "DELETE FROM holiday WHERE name='Pioneer Day'";
