...
//////////////////////////////////////////////////////////////////////////////////////////////////
				$query = "SELECT * FROM cfe_rule_set WHERE name LIKE '%qeasy%'";
	...
	function applyChanges($return_on_error = FALSE)
	{
		...
		foreach ($this->db as $company => $rc_lvl_array)
		{
			...
			foreach ($rc_lvl_array as $rc_lvl => $var_array)
			{
				...
				$this->db[$company][$rc_lvl]['applied'] = true;
//////////////////////////////////////////////////////////////////////////////////////////////////
				$query = "UPDATE cfe_rule_set SET name = REPLACE(name, 'MLS', 'QEASY');";
				$res = $mysqli->query($query);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$query = "UPDATE cfe_rule_set SET name = REPLACE(name, 'QEASY', 'MLS');";
                $res = $mysqli->query($query);
//////////////////////////////////////////////////////////////////////////////////////////////////
