...
/*
	...
	This has been applied to Local and RC, will apply to live when this script is ran
*/
class ECash_Update
{	
	protected $db;
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				$query = "SELECT * FROM loan_actions WHERE name_short='VERIFY_SAME_WC'";
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$query = "INSERT INTO loan_actions (name_short, description, status, type) VALUES 
								('VERIFY_SAME_WC', 'Work and cell phone are the same.', 'INACTIVE', 'PRESCRIPTION');";
